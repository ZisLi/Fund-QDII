...
fund_nasdaq.loc[fund_nasdaq["date"] >= "2026-04-14", "daily_invest"] = 15.00
...
fund_sp500.loc[fund_sp500["date"] >= "2026-04-15", "daily_invest"] = 15.00 * (1 - fee_rate)
# ----------- 手动加仓 -----------
extra = {
...
fund_global.loc[fund_global["date"] >= "2026-04-14", "daily_invest"] = 15.00
